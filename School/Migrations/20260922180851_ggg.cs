    ...
    public partial class ggg : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateOnly(2008, 5, 10), "ahmed.ali@gmail.com", "Ahmed", "Ali", "01012345678" },
                    { 2, 1, new DateOnly(2008, 8, 15), "mariam.hassan@gmail.com", "Mariam", "Hassan", "01123456789" }
                });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "TeacherId", "Email", "FirstName", "LastName", "Phone", "Salary", "departmentId" },
                values: new object[,]
                {
                    { 1, "alaa@gmail.com", "ALaa", "Soliman", "12345678910", 300, 1 },
                    { 2, "alaa@gmail.com", "ggg", "Soliman", "12345678910", 300, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 95, 1, 1 },
                    { 2, new DateTime(2026, 9, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), 88, 1, 2 },
                    { 3, new DateTime(2026, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 92, 2, 1 }
                });
